...
class TextMessages:
    ...
    help_text = '{} {} {} {}\n Чтобы вывести список команд еще раз, нажмите: "Алиса, помощь".'.format(repeat_text, capitulate_text, stats_text, exit_text)
    ...
    correct_answer = '😎 {}!\nСледующий вопрос ➡'.format(get_random_element(YES))
    incorrect_answer = '{}!\nПопробуйте еще раз'.format(get_random_element(NO))


class AudioMessages:
    repeat_sound = '↩ Чтобы повторить отрывок, скажите "Повтори".'
    ...
    help_sound = '{} {} {} {} Чтобы вывести список команд еще раз, скажите: "Алиса, помощь".'.format(repeat_sound, capitulate_sound, stats_sound, exit_sound)
